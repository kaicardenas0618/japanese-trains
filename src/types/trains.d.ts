...
export interface TrainTypeConfig {
  ...
  /**
   * Legacy/simple alias for allowing at-grade road crossings.
   *
   * Kept because the train API docs still mention it for tram/streetcar usage.
   */
  allowAtGradeRoadCrossing?: boolean;

  /** Alias for `allowAtGradeRoadCrossing`. */
